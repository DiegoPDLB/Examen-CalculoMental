"""
Proyecto Final - A01664407
Mini examen de habilidad matemática
Este codigo aplica al usuario una pequeña prueba de habilidad matemática con diferentes opciones de dificultad.
Al final de la prueba se le da al usuario un promedio con respecto a sus respuestas
"""

import time
"""
En esta funcion se recibe una lista con los datos del examen (pregunta y respuesta) para hacer una pregunta al 
usuario, aquí el puntaje es calculado dependiendo del tiempo tomado en contestar todas las preguntas de manera correcta.
"""
...
"""
Aquí estan todas la preguntas abiertas de ejercicios, donde se puede incluso modificar el resultado y la incognita.
"""
...
"""
Preguntas de introduccion al examen, nombre, tipo y dificultad.
"""
