import time
#En esta funcion se recibe una lista con los datos del examen (pregunta y respuesta) para hacer la pregunta
#al usuario, aquí el puntaje es calculado dependiendo del tiempo tardado en contestar todas las preguntas correctamente
...
#En esta funcion, a diferencia de la anterior, el puntaje se va añadiendo a una lista para posteriormente calcular el resultado
